          ...
          <div className="animate-slide-up order-2 lg:order-1" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 mb-6 sm:mb-8">
              {skills.map((skill, index) => (
                <span 
                  key={index}
                  className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium glass-light text-[#a09c97] hover:bg-[#1a1a1a] hover:border-[#3a3a37] hover:text-[#e8e6e3] transition-all duration-300 whitespace-nowrap"
                >
                  {skill}
                </span>
              ))}
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 items-center">
              ...
              <a
                  ...
                  rel="noopener noreferrer"
                    className="p-2.5 sm:p-3 md:p-4 rounded-full glass-light hover:bg-[#1a1a1a] hover:border-[#3a3a37] transition-all duration-300 group flex-shrink-0"
                    aria-label="LinkedIn"
                  >
          ...
          <div className="flex justify-center lg:justify-end animate-slide-up order-1 lg:order-2" style={{ animationDelay: '0.3s' }}>
            ...
            >
              ...
              >
                ...
                {/* Photo container */}
                <div className="relative w-full h-full rounded-2xl overflow-hidden glass-heavy shadow-2xl">
                  <img 
              ...
              <div 
                className="absolute left-0 sm:-left-2 top-1/4 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full glass-light text-[#a09c97] text-[10px] sm:text-xs font-medium whitespace-nowrap"
                style={{ transform: 'translateZ(30px)' }}
              >
                AI & ML
              </div>
              <div 
                className="absolute right-0 sm:-right-2 bottom-1/3 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full glass-light text-[#a09c97] text-[10px] sm:text-xs font-medium whitespace-nowrap"
                style={{ transform: 'translateZ(30px)' }}
              >
                Data Science
              </div>
